...
\begin{figure}[htb]
  \centering
   \subfigure[Runge-Kutta-Algorithmus 4. Ordnung\label{fig:label1}]
   {\input{a001b099uv1R}}
   \hfill
   \subfigure[Vergleich Runge-Kutta-Algorithmus mit Euler bei identischen Randbedingungen\label{fig:label2}]
   {\input{a001b099uv1ER}}
